 ...
 */
class ImageToTraceb(fileName: String) : info.benjaminhill.scriptgen.TODO.AbstractImageToX(fileName) {
    ...
    override fun run() {
        ...
        script.clear()
        script.addAll(info.benjaminhill.scriptgen.util.ramerDouglasPeucker(tmp, 3000))
